        ...
        *,
        ...
        if credential is None:
            if os.environ.get("AZURE_API_KEY") is None:
                print(f"AZURE_API_KEY not found, DefaultAzureCredential created")
                credential = DefaultAzureCredential()
            else:
                print(f"Found AZURE_API_KEY from env, created AzureKeyCredential")
    ...
    def convert(
        ...
        **kwargs: Any,  # Options to pass to the converter
        ...
        try:
            ...
            print(f"Azure Document Intelligence throws exception: {ex}")
            traceback.print_exc() 
            raise
        ...
        #print(f"Azure Document Intelligence returned result: {result}")
