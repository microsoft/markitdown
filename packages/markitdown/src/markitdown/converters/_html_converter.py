...
class HtmlConverter(DocumentConverter):
    ...
    def accepts(
        ...
        **kwargs: Any,  # Options to pass to the converter
        ...
        return False
    def __replace_embedded_images_with_llm_desc(self, soup: BeautifulSoup, **kwargs: Any) -> BeautifulSoup:
        """        
            ...
            for img in soup.find_all("img"):
                ...
                if src.startswith("data:image/"):
                    try:
                        ...
                        description = result.markdown.strip() if result.markdown else "Image description not available"
                        
                        # Replace the image with the description
                        desc_tag = soup.new_tag("p", attrs={"style":"border: 1px solid black"})
                        desc_tag.string = f"## [embedded image] ##\n ``` {description} ```"
