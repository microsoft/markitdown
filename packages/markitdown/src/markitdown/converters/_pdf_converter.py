...
def _clean_bullets(text: str) -> str:
    ...
    # Optional: Replace any remaining non-ASCII characters that might break 
    # Windows CP1252 if you want to be extra safe:
    # text = text.encode('ascii', 'ignore').decode('ascii') 
    
    return text
# def _clean_bullets(text: str) -> str:
#     # Common PDF bullet glyphs mapped to standard Markdown bullets
#     bullet_chars = {
#         '\uf0b7': '*',  # Standard round bullet
#         '\uf02d': '-',  # Hyphen bullet
#         '\u2022': '*',  # Bullet point
