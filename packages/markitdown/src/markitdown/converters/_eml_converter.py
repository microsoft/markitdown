...
class EmlConverter(DocumentConverter):
    """Converts EML (email) files to Markdown. Preserves headers, body, and attachment info."""
    ...
    def convert(
        ...
        **kwargs: Any,
        ...
        """Convert an EML email file to Markdown."""

        # Parse the email from the binary stream
        ...
        # Helper to format address headers (From, To, Cc, Bcc)
            ...
            for part in msg.walk():
                if part.get_content_disposition() == "attachment":
                    ...
                    if filename:
                        ...
                        attachments.append(f"- {filename} ({mime_type}, {size:,} bytes)")
