    ...
    def convert(
        ...
        **kwargs: Any,
        ...
        if ocr_service:
            ...
            return self._convert_with_ocr(file_stream, ocr_service, **kwargs_without_ocr)
        else:
            return self._convert_standard(file_stream, **kwargs)

    def _convert_standard(self, file_stream: BinaryIO, **kwargs: Any) -> DocumentConverterResult:
                        ...
                        if hasattr(img, 'anchor'):
                            ...
                            if hasattr(anchor, '_from'):
                                ...
                                if hasattr(from_cell, 'col') and hasattr(from_cell, 'row'):
                                    ...
                                    col_letter = self._column_number_to_letter(from_cell.col)
