...
def _pre_process_images(
    ...
    generated by an LLM (if provided), or with a Base64 placeholder otherwise.
    """
    soup = BeautifulSoup(content.decode(), features="xml")
            ...
            if rel_tag:
                ...
                if image_path in files:
                    ...
                    try:
                        ...
                        description = (llm_response or "Image could not be described").strip()
                    except Exception:
