---
component_id: 1.3
component_name: Converter Orchestration Engine
---

# Converter Orchestration Engine

## Component Description

Manages the registry of available converters (both built-in and external plugins) and implements the core execution logic. It iterates through registered converters and format guesses, managing stream state and error aggregation until a successful conversion is achieved.

---

## Key References:

### /Users/imilev/StartUp/repos/markitdown/packages/markitdown/src/markitdown/_markitdown.py (lines 74-764)
```
    _plugins = []
...
### /Users/imilev/StartUp/repos/markitdown/packages/markitdown/src/markitdown/_markitdown.py (lines 519-612)
```
        if file_extension is not None:
            # Deprecated -- use stream_info
            base_guess = base_guess.copy_and_update(extension=file_extension)
...
### /Users/imilev/StartUp/repos/markitdown/packages/markitdown/src/markitdown/_markitdown.py (lines 622-652)
```
                    return res
