---
component_id: 1
component_name: Core Orchestrator
---
...
The central management hub of the library. It handles converter registration, file type detection (guessing), and the primary dispatch logic for conversion requests.
