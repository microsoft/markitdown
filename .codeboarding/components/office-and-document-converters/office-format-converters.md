---
component_id: 3.1
component_name: Office Format Converters
---
...
Implements the Strategy pattern for Microsoft Office and Email formats. It leverages specialized libraries (e.g., mammoth, python-pptx) to extract text and structure while maintaining document integrity.
...
### /Users/imilev/StartUp/repos/markitdown/packages/markitdown/src/markitdown/converters/_pptx_converter.py (lines 34-264)
```
...
### /Users/imilev/StartUp/repos/markitdown/packages/markitdown/src/markitdown/converters/_xlsx_converter.py (lines 36-95)
```
